...
const AddExamScreen = ({pageSwitcher}: any) =>{
  ...
  const handleCommentSubmit = async() =>{
        ...
        await publicAxios.post(`/posts/exam`, {
            title: title,
            content: content,
            category: category,
    ...
    return(
        ...
        >
            ...
            >
                ...
                >
                    Dodaj tytuł, dział lub zagadnienie
                </Text>
                <Text
                ...
                <TextInput
                    ...
                    value={title}
                    placeholder='tytuł, dział lub zagadnienie...'
                />
                <Text
                    style={styles.hintText}
                >
                    Dodaj kategorie sprawdzianu
                </Text>
                <RNPickerSelect
                ...
                <Text
                    style={styles.smallHintText}
                >
                    Wpisz treści zadań lub dodaj zdjęcia poniżej
                </Text>
								<TextInput
									editable
									multiline
									...
									value={content}
									placeholder={'Treści zadań...'}
							/>
									<Text
										style={styles.hintText}
									>
										Dodaj zdjęcia, jeżeli takie posiadasz
									</Text>
                ...
                <TouchableOpacity
                    ...
                    >
                        ...
                        >
                            <Text style={{color:'white', fontWeight:'900', fontSize:22}}>Prześlij</Text>
                        </LinearGradient>
                </TouchableOpacity>
            </View> 
            </ScrollView>
