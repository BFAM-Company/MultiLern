...
import ExercisesCard from '../ExercisesScreen/ExercisesScreenComponents/ExercisesCard';
...
jest.mock('../ExercisesScreen/ExercisesScreenComponents/ExercisesCard', () => jest.fn(() => null));
  ...
  it('fetches data and updates state correctly', async () => {
    ...
    const { queryByTestId, getByText } = render(
        <AxiosContext.Provider value={mockAxiosContextValue}>
          <UserExercises userId="123" pageSwitcher={() => {}} />
