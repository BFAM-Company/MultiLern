  ...
  return (
    ...
    >
        ...
        >
            <Image
                style={styles.image}
                source={require('./../../../assets/notepad-bcg.png')}
            />
            <Text style={styles.buttonTitle}>Twoje Notatki</Text>
        ...
        >
            <Image
                style={styles.image}
                source={require('./../../../assets/pencilKit-icon.png')}
                resizeMode='contain'
                
            />
             <Text style={styles.buttonTitle}>Nowa Notatka</Text>
