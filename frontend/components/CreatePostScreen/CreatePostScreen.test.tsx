...
describe('CreatePostScreen', () => {
        ...
        return render(
            <UserDataContext.Provider value={mockUserContext}>
                <AxiosContext.Provider value={{ authAxios: mockPublicAxios, publicAxios: mockPublicAxios }}>
                    <CreatePostScreen pageSwitcher={mockPageSwitcher} />
    ...
    it('handles text input correctly', () => {
        ...
        const titleInput = getByPlaceholderText('tytuł...');
        const contentInput = getByPlaceholderText('Treść zadania...');
    ...
    it('submits the post correctly', async () => {
